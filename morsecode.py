...
def get_morse_code_dict_reverse():
    morse_code_dict = get_morse_code_dict()
    morse_code_dict_reverse = dict()
    for k, v in morse_code_dict.items():
        morse_code_dict_reverse[v] = k
    morse_code_dict_reverse[''] = ' '
    return morse_code_dict_reverse
...
def is_help_command(user_input):
    ...
    return user_input_lower == "h" or user_input_lower == "help"
    # ==================================
...
def is_validated_english_sentence(user_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당 또는 필요에 따라 자유로운 수정
    check_str_1 = "_@#$%^&*()-+=[]}{\"\';:\|`~0123456789"
    check_str_2 = ".,!?"
    check_int = 0
    for c in user_input:
        if c in check_str_1:
            return False
        if c not in check_str_2:
            check_int += 1
    return check_int > 0
    # ==================================
...
def encoding_character(english_character):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당 또는 필요에 따라 자유로운 수정
    if english_character == " ": return english_character
    morse_code_dict = get_morse_code_dict()
...
def main():
    ...
    # ===Modify codes below=============
    while(True):
        user_input = input("Input your messge(H - Help, 0 - Exit): ")
